...
// ********************************************************************
//
/// \file eli/src/eliPhysListEmPenelope_usr.cc
/// \brief Implementation of the eliPhysListEmPenelope_usr class
//
...
eliPhysListEmPenelope_usr::eliPhysListEmPenelope_usr(const G4String& name)
...
eliPhysListEmPenelope_usr::~eliPhysListEmPenelope_usr() {
}

/*void eliPhysListEmPenelope_usr::ConstructParticle() {
...
void eliPhysListEmPenelope_usr::ConstructProcess() {
	...
	while ((*theParticleIterator)()) {
		...
		if (particleName == "gamma") {
			...
			G4PenelopePhotoElectricModel* photModel =
			...
			G4PenelopeIonisationModel* eIoniModel =
			...
			G4PenelopeBremsstrahlungModel* eBremModel =
			...
			G4PenelopeAnnihilationModel* eAnniModel =
...
/*void eliPhysListEmPenelope_usr::SetCuts() {
